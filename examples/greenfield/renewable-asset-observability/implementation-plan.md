# Renewable asset observability - implementation plan
...
| --- | --- | --- | --- | --- | --- | --- |
| asset-event-contract | Approve the asset-event contract | dev-malik | asset-identity-validator | none | asset-event-contract-reviewed | Contract review accepts `EVD-GRN-020`. |
